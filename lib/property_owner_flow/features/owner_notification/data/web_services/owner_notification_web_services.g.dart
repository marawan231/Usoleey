...
class _OwnerNotificationWebService implements OwnerNotificationWebService {
  ...
  Future<BaseResponse<NotificationModel>> getOwnerNotification(
    ...
    final _options = _setStreamType<BaseResponse<NotificationModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late BaseResponse<NotificationModel> _value;
    try {
      _value = BaseResponse<NotificationModel>.fromJson(
        _result.data!,
