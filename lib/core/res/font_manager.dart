...
class FontManager {
  static const String fontFamily = "SF-Compact-Rounded";
...
class FontSize {
  ...
  static double s21 = 21.0.spMin;
  static double s22 = 22.0.spMin;
  static double s23 = 23.0.spMin;
  static double s24 = 24.0.spMin;
  static double s25 = 25.0.spMin;
  static double s26 = 26.0.spMin;
