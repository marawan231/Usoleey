...
part 'add_new_property_button.dart';
part 'create_unit_button.dart';
part 'create_unit_form.dart';
part 'my_properties.dart';
part 'properties_list.dart';
part 'properties_loading_widget.dart';
part 'property_details_textfields.dart';
part 'select_property.dart';
part 'switcher.dart';
part 'unit_image.dart';
part 'unit_information.dart';
part 'unit_property.dart';
